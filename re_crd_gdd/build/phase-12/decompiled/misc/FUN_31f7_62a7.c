// TIM2.EXE: FUN_31f7_62a7 @ file 0x03D417 Ghidra 0x38217
// Subsystem: misc | Size: 71 bytes


void __cdecl16far FUN_31f7_62a7(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_6227((int)param_1,param_1._2_2_);
