// TIM2.EXE: FUN_31f7_1994 @ file 0x038B04 Ghidra 0x33904
// Subsystem: misc | Size: 69 bytes


void __cdecl16far FUN_31f7_1994(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_1265((int)param_1,param_1._2_2_);
