// TIM2.EXE: FUN_50fb_0332 @ file 0x0564E2 Ghidra 0x512E2
// Subsystem: misc | Size: 162 bytes


void __cdecl16far FUN_50fb_0332(int *param_1,uint param_2)

{
  ...
  if (*(uint *)(*param_1 + 4) <= param_2) {
    FUN_50fb_00d9(local_4,(char *)s_String_reference_out_of_range_554c_5eb4,0x554c,0,0,0xa251,0x1000
                  ,1,0,0,0);
