// TIM2.EXE: FUN_31f7_661c @ file 0x03D78C Ghidra 0x3858C
// Subsystem: misc | Size: 58 bytes


void __cdecl16far FUN_31f7_661c(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_6362((int)param_1,param_1._2_2_);
