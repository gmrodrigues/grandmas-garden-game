// TIM2.EXE: FUN_31f7_49d6 @ file 0x03BB46 Ghidra 0x36946
// Subsystem: misc | Size: 58 bytes


void __cdecl16far FUN_31f7_49d6(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_4793((int)param_1,param_1._2_2_);
