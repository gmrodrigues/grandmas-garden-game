// TIM2.EXE: FUN_31f7_42ce @ file 0x03B43E Ghidra 0x3623E
// Subsystem: misc | Size: 69 bytes


void __cdecl16far FUN_31f7_42ce(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_425f((int)param_1,param_1._2_2_);
