// TIM2.EXE: FUN_31f7_8bd9 @ file 0x03FD49 Ghidra 0x3AB49
// Subsystem: misc | Size: 82 bytes


void __cdecl16far FUN_31f7_8bd9(undefined4 param_1,int param_2)

{
  if (param_2 != 0) {
    *(uint *)((int)param_1 + 0xc) = *(uint *)((int)param_1 + 0xc) ^ 0x10;
  }
  FUN_31f7_891e((int)param_1,param_1._2_2_);
