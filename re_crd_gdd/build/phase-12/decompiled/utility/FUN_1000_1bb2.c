// TIM2.EXE: FUN_1000_1bb2 @ file 0x016DB2 Ghidra 0x11BB2
// Subsystem: utility | Size: 125 bytes


char * FUN_1000_1bb2(char param_1,char param_2,uint param_3,char *param_4,uint param_5,uint param_6)

{
  ...
  if ((param_3 < 0x25) && (1 < (byte)param_3)) {
    ...
    pbVar6 = local_24;
    if (param_6 == 0) goto LAB_1000_1bfc;
    do {
      uVar3 = (ulong)param_6;
