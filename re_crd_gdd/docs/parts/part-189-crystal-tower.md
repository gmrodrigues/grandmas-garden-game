...
| Part Type | `189` |
| Category | Scenery |
| Description | Background detail panel (56x50) |
| ANM File | `PART189.ANM` → `build/phase-4/anm/PART189.json` |
| BMP Resource | `PART189.BMP` → `build/phase-3/bitmaps/PART189_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART189.json` |
| Sprite PNGs | `godot/assets/sprites/PART189_*.png` |
...
*Generated from `build/phase-4/anm/PART189.json` + `build/phase-5/yaml/`*
