...
| Part Type | `248` |
| Category | Scenery |
| Description | Dark wood tile (32x21) |
| ANM File | `PART248.ANM` → `build/phase-4/anm/PART248.json` |
| BMP Resource | `PART248.BMP` → `build/phase-3/bitmaps/PART248_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART248.json` |
| Sprite PNGs | `godot/assets/sprites/PART248_*.png` |
...
*Generated from `build/phase-4/anm/PART248.json` + `build/phase-5/yaml/`*
