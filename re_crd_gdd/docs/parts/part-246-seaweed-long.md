...
| Part Type | `246` |
| Category | Scenery |
| Description | Wood divider strip (16x66) |
| ANM File | `PART246.ANM` → `build/phase-4/anm/PART246.json` |
| BMP Resource | `PART246.BMP` → `build/phase-3/bitmaps/PART246_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART246.json` |
| Sprite PNGs | `godot/assets/sprites/PART246_*.png` |
...
*Generated from `build/phase-4/anm/PART246.json` + `build/phase-5/yaml/`*
