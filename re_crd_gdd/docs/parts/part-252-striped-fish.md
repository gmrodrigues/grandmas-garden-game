...
| Part Type | `252` |
| Category | Scenery |
| Description | Mini wood tile (24x19) |
| ANM File | `PART252.ANM` → `build/phase-4/anm/PART252.json` |
| BMP Resource | `PART252.BMP` → `build/phase-3/bitmaps/PART252_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART252.json` |
| Sprite PNGs | `godot/assets/sprites/PART252_*.png` |
...
*Generated from `build/phase-4/anm/PART252.json` + `build/phase-5/yaml/`*
