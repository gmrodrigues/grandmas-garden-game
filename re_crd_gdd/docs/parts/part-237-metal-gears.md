...
| Part Type | `237` |
| Category | Scenery |
| Description | Tiny wood joint (16x18) |
| ANM File | `PART237.ANM` → `build/phase-4/anm/PART237.json` |
| BMP Resource | `PART237.BMP` → `build/phase-3/bitmaps/PART237_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART237.json` |
| Sprite PNGs | `godot/assets/sprites/PART237_*.png` |
...
*Generated from `build/phase-4/anm/PART237.json` + `build/phase-5/yaml/`*
