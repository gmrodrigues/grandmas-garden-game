...
| ANM File | `PART128.ANM` → `build/phase-4/anm/PART128.json` |
| BMP Resource | `PART128.BMP` → `build/phase-3/bitmaps/PART128_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART128.json` |
| Sprite PNGs | `godot/assets/sprites/PART128_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART128.json` + `build/phase-5/yaml/`*
