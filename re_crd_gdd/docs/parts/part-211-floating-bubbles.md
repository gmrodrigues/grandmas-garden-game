...
| Part Type | `211` |
| Category | Scenery |
| Description | Short ice pillar (16x40) |
| ANM File | `PART211.ANM` → `build/phase-4/anm/PART211.json` |
| BMP Resource | `PART211.BMP` → `build/phase-3/bitmaps/PART211_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART211.json` |
| Sprite PNGs | `godot/assets/sprites/PART211_*.png` |
...
*Generated from `build/phase-4/anm/PART211.json` + `build/phase-5/yaml/`*
