...
| ANM File | `PART133.ANM` → `build/phase-4/anm/PART133.json` |
| BMP Resource | `PART133.BMP` → `build/phase-3/bitmaps/PART133_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART133.json` |
| Sprite PNGs | `godot/assets/sprites/PART133_f*.png` |
| Level YAML | `godot/assets/levels/ELEV14.yaml` |
| Level YAML | `godot/assets/levels/MLEV23.yaml` |

---

*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART133.json` + `build/phase-5/yaml/`*
