...
| ANM File | `PART141.ANM` → `build/phase-4/anm/PART141.json` |
| BMP Resource | `PART141.BMP` → `build/phase-3/bitmaps/PART141_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART141.json` |
| Sprite PNGs | `godot/assets/sprites/PART141_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART141.json` + `build/phase-5/yaml/`*
