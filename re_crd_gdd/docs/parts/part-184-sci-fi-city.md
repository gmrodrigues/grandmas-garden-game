...
| Part Type | `184` |
| Category | Scenery |
| Description | Ice block tile (80x47) |
| ANM File | `PART184.ANM` → `build/phase-4/anm/PART184.json` |
| BMP Resource | `PART184.BMP` → `build/phase-3/bitmaps/PART184_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART184.json` |
| Sprite PNGs | `godot/assets/sprites/PART184_*.png` |
| Level YAML | `godot/assets/levels/MLEV26.yaml` |
| Level YAML | `godot/assets/levels/RLEV5.yaml` |

---

*Generated from `build/phase-4/anm/PART184.json` + `build/phase-5/yaml/`*
