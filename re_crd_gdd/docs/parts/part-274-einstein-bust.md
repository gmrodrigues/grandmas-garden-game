...
| Part Type | `274` |
| Category | Scenery |
| Description | Background decoration (40x46) |
| ANM File | `PART274.ANM` → `build/phase-4/anm/PART274.json` |
| BMP Resource | `PART274.BMP` → `build/phase-3/bitmaps/PART274_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART274.json` |
| Sprite PNGs | `godot/assets/sprites/PART274_*.png` |
| Level YAML | `godot/assets/levels/HLEV30.yaml` |
| Level YAML | `godot/assets/levels/RLEV2.yaml` |

---

*Generated from `build/phase-4/anm/PART274.json` + `build/phase-5/yaml/`*
