...
| Part Type | `205` |
| Category | Scenery |
| Description | Blue ice/water surface (72x72) |
| ANM File | `PART205.ANM` → `build/phase-4/anm/PART205.json` |
| BMP Resource | `PART205.BMP` → `build/phase-3/bitmaps/PART205_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART205.json` |
| Sprite PNGs | `godot/assets/sprites/PART205_*.png` |
...
*Generated from `build/phase-4/anm/PART205.json` + `build/phase-5/yaml/`*
