...
| ANM File | `PART115.ANM` → `build/phase-4/anm/PART115.json` |
| BMP Resource | `PART115.BMP` → `build/phase-3/bitmaps/PART115_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART115.json` |
| Sprite PNGs | `godot/assets/sprites/PART115_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART115.json` + `build/phase-5/yaml/`*
