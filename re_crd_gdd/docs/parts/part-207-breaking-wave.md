...
| Part Type | `207` |
| Category | Scenery |
| Description | Ice ledge section (112x18) |
| ANM File | `PART207.ANM` → `build/phase-4/anm/PART207.json` |
| BMP Resource | `PART207.BMP` → `build/phase-3/bitmaps/PART207_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART207.json` |
| Sprite PNGs | `godot/assets/sprites/PART207_*.png` |
...
*Generated from `build/phase-4/anm/PART207.json` + `build/phase-5/yaml/`*
