...
| Part Type | `158` |
| Category | Scenery |
| Description | Iceberg with white snowcap (72x42) |
| ANM File | `PART158.ANM` → `build/phase-4/anm/PART158.json` |
| BMP Resource | `PART158.BMP` → `build/phase-3/bitmaps/PART158_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART158.json` |
| Sprite PNGs | `godot/assets/sprites/PART158_*.png` |
...
*Generated from `build/phase-4/anm/PART158.json` + `build/phase-5/yaml/`*
