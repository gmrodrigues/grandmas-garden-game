...
| Part Type | `195` |
| Category | Scenery |
| Description | Snow bank top (64x30) |
| ANM File | `PART195.ANM` → `build/phase-4/anm/PART195.json` |
| BMP Resource | `PART195.BMP` → `build/phase-3/bitmaps/PART195_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART195.json` |
| Sprite PNGs | `godot/assets/sprites/PART195_*.png` |
...
*Generated from `build/phase-4/anm/PART195.json` + `build/phase-5/yaml/`*
