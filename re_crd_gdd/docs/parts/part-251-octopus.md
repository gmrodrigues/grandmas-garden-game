...
| Part Type | `251` |
| Category | Scenery |
| Description | Wood texture panel (48x33) |
| ANM File | `PART251.ANM` → `build/phase-4/anm/PART251.json` |
| BMP Resource | `PART251.BMP` → `build/phase-3/bitmaps/PART251_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART251.json` |
| Sprite PNGs | `godot/assets/sprites/PART251_*.png` |
...
*Generated from `build/phase-4/anm/PART251.json` + `build/phase-5/yaml/`*
