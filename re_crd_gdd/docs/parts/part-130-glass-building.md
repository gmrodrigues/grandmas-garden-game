...
| ANM File | `PART130.ANM` → `build/phase-4/anm/PART130.json` |
| BMP Resource | `PART130.BMP` → `build/phase-3/bitmaps/PART130_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART130.json` |
| Sprite PNGs | `godot/assets/sprites/PART130_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART130.json` + `build/phase-5/yaml/`*
