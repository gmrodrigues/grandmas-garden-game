...
| Part Type | `261` |
| Category | Scenery |
| Description | Ice surface tile (104x35) |
| ANM File | `PART261.ANM` → `build/phase-4/anm/PART261.json` |
| BMP Resource | `PART261.BMP` → `build/phase-3/bitmaps/PART261_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART261.json` |
| Sprite PNGs | `godot/assets/sprites/PART261_*.png` |
...
*Generated from `build/phase-4/anm/PART261.json` + `build/phase-5/yaml/`*
