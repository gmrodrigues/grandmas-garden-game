...
| Part Type | `260` |
| Category | Scenery |
| Description | Wide flat ice surface (120x35) |
| ANM File | `PART260.ANM` → `build/phase-4/anm/PART260.json` |
| BMP Resource | `PART260.BMP` → `build/phase-3/bitmaps/PART260_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART260.json` |
| Sprite PNGs | `godot/assets/sprites/PART260_*.png` |
...
*Generated from `build/phase-4/anm/PART260.json` + `build/phase-5/yaml/`*
