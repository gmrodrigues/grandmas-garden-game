...
| Part Type | `233` |
| Category | Scenery |
| Description | Small wood tile (32x21) |
| ANM File | `PART233.ANM` → `build/phase-4/anm/PART233.json` |
| BMP Resource | `PART233.BMP` → `build/phase-3/bitmaps/PART233_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART233.json` |
| Sprite PNGs | `godot/assets/sprites/PART233_*.png` |
...
*Generated from `build/phase-4/anm/PART233.json` + `build/phase-5/yaml/`*
