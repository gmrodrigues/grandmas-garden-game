...
| Part Type | `259` |
| Category | Scenery |
| Description | Small flat wood (32x21) |
| ANM File | `PART259.ANM` → `build/phase-4/anm/PART259.json` |
| BMP Resource | `PART259.BMP` → `build/phase-3/bitmaps/PART259_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART259.json` |
| Sprite PNGs | `godot/assets/sprites/PART259_*.png` |
...
*Generated from `build/phase-4/anm/PART259.json` + `build/phase-5/yaml/`*
