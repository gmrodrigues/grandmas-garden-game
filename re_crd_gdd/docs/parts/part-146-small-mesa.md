...
| ANM File | `PART146.ANM` → `build/phase-4/anm/PART146.json` |
| BMP Resource | `PART146.BMP` → `build/phase-3/bitmaps/PART146_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART146.json` |
| Sprite PNGs | `godot/assets/sprites/PART146_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART146.json` + `build/phase-5/yaml/`*
