...
| Part Type | `238` |
| Category | Scenery |
| Description | Small vertical wood (24x35) |
| ANM File | `PART238.ANM` → `build/phase-4/anm/PART238.json` |
| BMP Resource | `PART238.BMP` → `build/phase-3/bitmaps/PART238_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART238.json` |
| Sprite PNGs | `godot/assets/sprites/PART238_*.png` |
...
*Generated from `build/phase-4/anm/PART238.json` + `build/phase-5/yaml/`*
