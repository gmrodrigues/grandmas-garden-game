...
| Part Type | `229` |
| Category | Scenery |
| Description | Wood texture tile (56x42) |
| ANM File | `PART229.ANM` → `build/phase-4/anm/PART229.json` |
| BMP Resource | `PART229.BMP` → `build/phase-3/bitmaps/PART229_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART229.json` |
| Sprite PNGs | `godot/assets/sprites/PART229_*.png` |
| Level YAML | `godot/assets/levels/ELEV20.yaml` |
| Level YAML | `godot/assets/levels/RLEV1.yaml` |

---

*Generated from `build/phase-4/anm/PART229.json` + `build/phase-5/yaml/`*
