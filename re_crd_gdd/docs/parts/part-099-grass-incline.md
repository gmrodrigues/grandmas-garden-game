...
| Part Type | `99` |
| Category | Inclines |
| Description | Roll balls and other parts up or down this grass incline. Use it to control the direction of balloons and other objects. It can be stretched or shrunk, which changes the angle. It's not affected by explosives. |
| ANM File | `PART99.ANM` → `build/phase-4/anm/PART99.json` |
| BMP Resource | `PART99.BMP` → `build/phase-3/bitmaps/PART99_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART99.json` |
| Sprite PNGs | `godot/assets/sprites/PART99_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART99.json` + `build/phase-5/yaml/`*
