...
| Part Type | `244` |
| Category | Scenery |
| Description | Tall wood strip (32x68) |
| ANM File | `PART244.ANM` → `build/phase-4/anm/PART244.json` |
| BMP Resource | `PART244.BMP` → `build/phase-3/bitmaps/PART244_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART244.json` |
| Sprite PNGs | `godot/assets/sprites/PART244_*.png` |
...
*Generated from `build/phase-4/anm/PART244.json` + `build/phase-5/yaml/`*
