...
| Part Type | `250` |
| Category | Scenery |
| Description | Crystal ice detail (32x27) |
| ANM File | `PART250.ANM` → `build/phase-4/anm/PART250.json` |
| BMP Resource | `PART250.BMP` → `build/phase-3/bitmaps/PART250_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART250.json` |
| Sprite PNGs | `godot/assets/sprites/PART250_*.png` |
...
*Generated from `build/phase-4/anm/PART250.json` + `build/phase-5/yaml/`*
