...
| Part Type | `209` |
| Category | Scenery |
| Description | Tall ice column (16x81) |
| ANM File | `PART209.ANM` → `build/phase-4/anm/PART209.json` |
| BMP Resource | `PART209.BMP` → `build/phase-3/bitmaps/PART209_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART209.json` |
| Sprite PNGs | `godot/assets/sprites/PART209_*.png` |
...
*Generated from `build/phase-4/anm/PART209.json` + `build/phase-5/yaml/`*
