...
| Part Type | `190` |
| Category | Scenery |
| Description | Background panel (88x53) |
| ANM File | `PART190.ANM` → `build/phase-4/anm/PART190.json` |
| BMP Resource | `PART190.BMP` → `build/phase-3/bitmaps/PART190_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART190.json` |
| Sprite PNGs | `godot/assets/sprites/PART190_*.png` |
...
*Generated from `build/phase-4/anm/PART190.json` + `build/phase-5/yaml/`*
