...
| Part Type | `179` |
| Category | Scenery |
| Description | Tiny ice connector joint (24x17) |
| ANM File | `PART179.ANM` → `build/phase-4/anm/PART179.json` |
| BMP Resource | `PART179.BMP` → `build/phase-3/bitmaps/PART179_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART179.json` |
| Sprite PNGs | `godot/assets/sprites/PART179_*.png` |
...
*Generated from `build/phase-4/anm/PART179.json` + `build/phase-5/yaml/`*
