...
| Description | Hitch this conveyor belt to a motor by adding a belt. Then use it to move objects. Add a gear to make it change directions. |
| ANM File | `PART5.ANM` → `build/phase-4/anm/PART5.json` |
| BMP Resource | `PART5.BMP` → `build/phase-3/bitmaps/PART5_f*.png` |
| Created Part | No |
| Interactive | No |

## Levels Using This Part

**61 level(s)** use this part type:
...
| ANM JSON | `build/phase-4/anm/PART5.json` |
| Sprite PNGs | `godot/assets/sprites/PART5_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART5.json` + `build/phase-5/yaml/`*
