...
| Description | This large wooden barrier can be used to fill spaces so objects can't pass through. You can set things on top of it, or bounce things off it. But you can't blow it up. |
| ANM File | `PART104.ANM` → `build/phase-4/anm/PART104.json` |
| BMP Resource | `PART104.BMP` → `build/phase-3/bitmaps/PART104_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART104.json` |
| Sprite PNGs | `godot/assets/sprites/PART104_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART104.json` + `build/phase-5/yaml/`*
