...
| Part Type | `183` |
| Category | Scenery |
| Description | Background block (88x57) |
| ANM File | `PART183.ANM` → `build/phase-4/anm/PART183.json` |
| BMP Resource | `PART183.BMP` → `build/phase-3/bitmaps/PART183_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART183.json` |
| Sprite PNGs | `godot/assets/sprites/PART183_*.png` |
...
*Generated from `build/phase-4/anm/PART183.json` + `build/phase-5/yaml/`*
