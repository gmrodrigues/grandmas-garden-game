...
| Part Type | `180` |
| Category | Scenery |
| Description | Wood roof/canopy (96x54) |
| ANM File | `PART180.ANM` → `build/phase-4/anm/PART180.json` |
| BMP Resource | `PART180.BMP` → `build/phase-3/bitmaps/PART180_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART180.json` |
| Sprite PNGs | `godot/assets/sprites/PART180_*.png` |
...
*Generated from `build/phase-4/anm/PART180.json` + `build/phase-5/yaml/`*
