...
| ANM File | `PART129.ANM` → `build/phase-4/anm/PART129.json` |
| BMP Resource | `PART129.BMP` → `build/phase-3/bitmaps/PART129_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART129.json` |
| Sprite PNGs | `godot/assets/sprites/PART129_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART129.json` + `build/phase-5/yaml/`*
