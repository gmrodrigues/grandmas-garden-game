...
| Part Type | `258` |
| Category | Scenery |
| Description | Micro flat wood (32x11) |
| ANM File | `PART258.ANM` → `build/phase-4/anm/PART258.json` |
| BMP Resource | `PART258.BMP` → `build/phase-3/bitmaps/PART258_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART258.json` |
| Sprite PNGs | `godot/assets/sprites/PART258_*.png` |
...
*Generated from `build/phase-4/anm/PART258.json` + `build/phase-5/yaml/`*
