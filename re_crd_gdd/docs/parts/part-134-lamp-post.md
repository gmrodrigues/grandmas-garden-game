...
| ANM File | `PART134.ANM` → `build/phase-4/anm/PART134.json` |
| BMP Resource | `PART134.BMP` → `build/phase-3/bitmaps/PART134_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART134.json` |
| Sprite PNGs | `godot/assets/sprites/PART134_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART134.json` + `build/phase-5/yaml/`*
