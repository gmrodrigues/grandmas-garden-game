...
| ANM File | `PART131.ANM` → `build/phase-4/anm/PART131.json` |
| BMP Resource | `PART131.BMP` → `build/phase-3/bitmaps/PART131_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART131.json` |
| Sprite PNGs | `godot/assets/sprites/PART131_f*.png` |
...
*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART131.json` + `build/phase-5/yaml/`*
