...
| Part Type | `187` |
| Category | Scenery |
| Description | Background cap piece (88x33) |
| ANM File | `PART187.ANM` → `build/phase-4/anm/PART187.json` |
| BMP Resource | `PART187.BMP` → `build/phase-3/bitmaps/PART187_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART187.json` |
| Sprite PNGs | `godot/assets/sprites/PART187_*.png` |
...
*Generated from `build/phase-4/anm/PART187.json` + `build/phase-5/yaml/`*
