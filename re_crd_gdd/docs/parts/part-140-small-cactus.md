...
| ANM File | `PART140.ANM` → `build/phase-4/anm/PART140.json` |
| BMP Resource | `PART140.BMP` → `build/phase-3/bitmaps/PART140_f*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART140.json` |
| Sprite PNGs | `godot/assets/sprites/PART140_f*.png` |

---

*Generated from `build/phase-16/godot/behaviors.json` + `build/phase-9/part-properties.json` + `build/phase-4/anm/PART140.json` + `build/phase-5/yaml/`*
