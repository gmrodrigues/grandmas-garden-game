...
| Part Type | `218` |
| Category | Scenery |
| Description | Large wood block (112x91) |
| ANM File | `PART218.ANM` → `build/phase-4/anm/PART218.json` |
| BMP Resource | `PART218.BMP` → `build/phase-3/bitmaps/PART218_*.png` |
| Created Part | No |
| Interactive | No |
...
| ANM JSON | `build/phase-4/anm/PART218.json` |
| Sprite PNGs | `godot/assets/sprites/PART218_*.png` |
| Level YAML | `godot/assets/levels/ELEV1.yaml` |
| Level YAML | `godot/assets/levels/HLEV10.yaml` |

---

*Generated from `build/phase-4/anm/PART218.json` + `build/phase-5/yaml/`*
